...
class SmoothACTInferenceNode:
    ...
    def _setup_ros_interfaces(self):
        ...
        try:
            ...
            if self.instruction_source == 'topic':
                ...
                rospy.loginfo("  支持的指令: wave, welcome, none")
            rospy.loginfo("控制服务:")
    ...
    def _instruction_callback(self, msg: VLACommand):
        ...
        try:
            ...
            # 验证指令有效性
            valid_instructions = ['wave', 'welcome', 'none']
    ...
    def _intelligent_action_completion(self, recent_trajectory, current_position):
        ...
        instruction_map = {0: 'wave', 1: 'welcome'}
...
def main():
    ...
    parser.add_argument('--instruction', default='wave', help='指令类型 (wave/welcome/none)')
